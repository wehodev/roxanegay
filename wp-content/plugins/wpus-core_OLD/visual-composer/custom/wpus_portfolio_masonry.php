<?php
/**
 * Visual Composer: Portfolio Masonry
 * 
 * @package Adamas
...
vc_map( array(
    ...
    'base'        => 'wpus_portfolio_masonry',
    'icon'        => 'icon-wpus-portfolio-masonry',
    'category'    => esc_html__( 'Built for Adamas', 'wpus-core' ),
    'name'        => esc_html__( 'Portfolio Masonry', 'wpus-core' ),
    'description' => esc_html__( 'Add portfolio masonry', 'wpus-core' ),
    'params'      => array(
        ...
        array(
            ...
            'heading'     => __( 'Masonry Style', 'wpus-core' ),
            'description' => __( 'Select masonry style.', 'wpus-core' ),
            'value'       => array( esc_html__( 'Default - set size in project page', 'wpus-core' ) => 'default' ) + array_flip( AdamasShared::masonry_style() ),
            'std'         => 'default',
        ),
