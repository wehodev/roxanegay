...
vc_map( array(
    ...
    'base'        => 'wpus_flickr',
    'icon'        => 'icon-wpus-flickr',
    'category'    => esc_html__( 'Built for Adamas', 'wpus-core' ),
    'name'        => esc_html__( 'Flickr', 'wpus-core' ),
    'description' => esc_html__( 'Add flickr', 'wpus-core' ),
    'params'      => array(
        ...
        array(
            ...
            'description' => esc_html__( 'Select flickr type.', 'wpus-core' ),
            'value'       => array(
        ...
        array(
            'type'        => 'textfield',
            'param_name'  => 'username',
            'heading'     => esc_html__( 'Flickr ID', 'wpus-core' ),
            'description' => sprintf( __( 'To find your flickID visit %s.', 'wpus-core' ), '<a href="http://idgettr.com/" target="_blank">idGettr</a>' ),
            'admin_label' => true,
        ),
