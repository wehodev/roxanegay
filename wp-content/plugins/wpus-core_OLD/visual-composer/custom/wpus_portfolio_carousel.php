...
vc_map( array(
    ...
    'base'        => 'wpus_portfolio_carousel',
    'icon'        => 'icon-wpus-portfolio-carousel',
    'category'    => esc_html__( 'Built for Adamas', 'wpus-core' ),
    'name'        => esc_html__( 'Portfolio Carousel', 'wpus-core' ),
    'description' => esc_html__( 'Add portfolio carousel', 'wpus-core' ),
    'params'      => array(
