...
?>
    ...
    <?php if ( has_post_thumbnail() ) { ?>
        ...
        <div class="col-md-1 hidden-sm hidden-xs">
            <div class="product-thumbnails swiper-container" data-count="<?php echo intval( $number_of_thumbs ) ?>">
                ...
                $thumbnail_swiper_height = $shop_thumbnail_image['height'] * $number_of_thumbs; // 20 is the padding between thumbs
                ?>
